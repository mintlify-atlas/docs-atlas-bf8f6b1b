---
title: "The v Namespace — Baseflare Validator API Reference"
sidebarTitle: "v (validators)"
description: "Reference for the v namespace in baseflare/values: all 15 validators, modifier methods, the Validator interface, and exported TypeScript utility types."
---
...
<ResponseField name="Infer<TValidator>" type="type">
...
<ResponseField name="InputOf<TValidator>" type="type">
...
<ResponseField name="NumberValidator<TInput, TOutput, TOptional, THasDefault>" type="interface">
...
<ResponseField name="ValidatorKind" type="type">
...
<ResponseField name="ValidatorShape" type="type">
  `Record<string, AnyValidator>` — the type of the `shape` argument to `v.object()`.
</ResponseField>

<ResponseField name="ValidatorDefinition" type="interface">
...
<ResponseField name="ObjectInput<TShape>" type="type">
...
<ResponseField name="ObjectOutput<TShape>" type="type">
...
<ResponseField name="Primitive" type="type">
