---
title: "Authentication with defineAuth and better-auth"
sidebarTitle: "Auth"
description: "Baseflare plans to integrate better-auth v1.6 via a custom document adapter, storing auth data in the same D1 tables. ctx.auth provides the current user in all function contexts."
---
