...
description: "Baseflare is an open-source, self-hosted backend framework that brings Convex-style DX to Cloudflare Workers, D1, R2, and Durable Objects — on your own account."
---
